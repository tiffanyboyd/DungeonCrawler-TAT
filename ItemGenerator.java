...
public class ItemGenerator {
	...
	ArrayList<Item> items = new ArrayList<Item>();
        ...
        items.add(new Item(ItemType.Armor, "Crew Uniform", 1, 5, 15));
        items.add(new Item(ItemType.Other, "Medipack", 1, 4, 13));
        items.add(new Item(ItemType.Weapon, "Stun Baton", 4, 69, 70));
        items.add(new Item(ItemType.Armor, "Normal Suit", 1, 5, 14));
        ...
        items.add(new Item(ItemType.Armor, "Hostile Enviornment Suit", 1, 50, 50));
        items.add(new Item(ItemType.Weapon, "Net Launcher", 1, 15, 25));
        items.add(new Item(ItemType.Armor, "Industrial Exosuit", 1, 60, 30));
